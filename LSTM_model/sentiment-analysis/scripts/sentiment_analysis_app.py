...
with intro1:
    ...
    with st.expander("**Model Characteristics**"):
        ...
        st.write("6. **Learning Rate**: 0.0005 to 0.00001, adjusted dynamically using CosineAnnealingLR")
        ...
        st.write("""**Additional Note**: codes for model training can be found in the [notebook]().""")

    with st.expander("**Model Stats**"):
        st.write("1. **Training Epochs**: 10")
        st.write("2. **Validation Loss**: 0.214")
        st.write("3. **Validation Accuracy**: 92.0%")
        st.write("4. **Validation Precision**: 0.97")
        st.write("5. **Validation Recall (Sensitivity)**: 0.89")
        st.write("6. **Validation F1 score**: 0.93")
